...
module.exports = {
  old: {
    ...
    translations: [{id: 'nl-nl', name: 'nl-nl'}],
    license: '',
    author: '',
    resources: [{
      ...
      },
      {
        ...
        schema: {
          fields: [{name: 'company'},
            ...
            {name: 'anno'},
            {name: 'lines_of_code'}],
          primaryKey: ['company', 'project', 'anno']
        }
      },
      {
        ...
        schema: {
          fields: [{name: 'company'},
            {name: 'project'},
            {name: 'lines_of_code'}],
          primaryKey: ['company', 'project']
        }
      },
      {
        path: 'ddf--datapoints--meeting_type--popularity--methodology--by--company--project--anno.csv',
        name: 'ddf--datapoints--meeting_type--popularity--methodology--by--company--project--anno',
        schema: {
          fields: [{name: 'company'},
            {name: 'project'},
            {name: 'anno'},
      ...
      },
      {
        ...
        schema: {
          fields: [{name: 'region'}, {name: 'full_name_changed'}],
          primaryKey: 'region'
        }
      }]
  },
  new: {
    ...
    resources: [{
      ...
      {
        path: 'ddf--datapoints--meeting_style--popular_appeal--methodology--by--company--project--anno.csv',
        name: 'ddf--datapoints--meeting_style--popular_appeal--methodology--by--company--project--anno',
        schema: {
          fields: [{name: 'company'},
            {name: 'project'},
            {name: 'anno'},
