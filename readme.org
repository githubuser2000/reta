...
+ Testing und Debugging Notes statt Feature-Ideen
  + obere html radiobuttons funktionieren manchmal nach mehreren Anclicken falsch, wenn man nicht resettet auf alles anzeigen lassen.
  ...
  + Stimmungen Kombinationen sollte nicht später ausgegraut bleiben
