...
*** 2. Feature Ideen
+ Alle Spalten zu Meta-Konkret sind verschwunden.
+ Bug bei:
  reta -zeilen --vorhervonausschnitt=2 -spalten --Meta_vs_Konkret_(Universum)=konkret
+ unvollständig eingebaut: --alles hat noch nicht alles dabei in Neuimplementierung
+ überall unsicherheit ergänzen bei allen n/m absichten.
