...
*** 2. Feature Ideen
+ Dass es wieder geht reta befehl zu speichern und dann nur eine Zeilenangabe machen, und umgekehrt
  Dazu muss wohl nur etwas aus stext gelöscht werden.
+ Kurzbefehl complex für commons stufen
+ Kurzbefehl, um Überschriften weg zu bekommen: ee statt e - d.h. Neue KurzKurzBefehlKategorie der Steigerung der eigenen Wirkung - sollte ich?
...
+ Dass man in der html per Parameter Dinge vorselektieren kann.
